 ...
 * @param {org.kpp.shipping.perishable.ShipmentReceived} shipmentReceived - the ShipmentReceived transaction
 * @transaction
 */
function payOut(shipmentReceived) {
    ...
    return getParticipantRegistry('org.kpp.shipping.perishable.Grower')
        .then(function (growerRegistry) {
            // update the grower's balance
            return growerRegistry.update(contract.grower);
        })
        .then(function () {
            return getParticipantRegistry('org.kpp.shipping.perishable.Importer');
        })
        ...
        .then(function () {
            return getAssetRegistry('org.kpp.shipping.perishable.Shipment');
        })
 ...
 * @param {org.kpp.shipping.perishable.TemperatureReading} temperatureReading - the TemperatureReading transaction
 * @transaction
 */
function temperatureReading(temperatureReading) {

    var shipment = temperatureReading.shipment;
    var NS = 'org.kpp.shipping.perishable';
 ...
 * @param {org.kpp.shipping.perishable.AccelReading} AccelReading - the AccelReading transaction
 * @transaction
 */
 ...
 * @param {org.kpp.shipping.perishable.GpsReading} gpsReading - the GpsReading transaction
 * @transaction
 */
 ...
 * @param {org.kpp.shipping.perishable.SetupDemo} setupDemo - the SetupDemo transaction
 * @transaction
 */
